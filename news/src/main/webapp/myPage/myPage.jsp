...
<script>
	function fn_mod_member(obj){
		obj.action="${contextPath}/member/modmember.do"
		obj.submit();
	}
	...
	function fn_delete_account(obj){
		let confirmation = confirm("정말 삭제하시겠습니까?");
		if(confirmation){
			obj.action="${contextPath}/member/deleteAccount.do"
			obj.submit();
		} else {
...
<div class="myprofile">
  <div class="header profile">
    ...
    <div class="button">
      ...
      <a class="close" href="${contextPath }/news">&times;</a>
    </div>
    <div class="info">
  ...
  <div class="business">
    ...
    <table>
     <tr class="section">
       <td><input type="button" class="button000" title="수정하기" value="계정 수정하기" onClick="fn_mod_member(this.form)"></input></td>
        <td><input type="button" class="button000" title="삭제하기" value="계정 삭제하기" onClick="fn_delete_account(this.form)"></input></td>
        <td><input type="button" class="button000" title="로그아웃" value="로그아웃하기" onClick="fn_logOut(this.form)"></input></td>
     </tr>
